...
| 🗹            | XCUP   | Change to the parent of the current working directory (alias de CDUP).                                                                                 |
| 🗹            | XMKD   | Make a directory (alias de MKD).                                                                                                                       |
| 🗹            | XPWD   | Print the current working directory (alias de PWD).                                                                                                    |
| ☐            | XRCP   |                                                                                                                                                        |
| 🗹            | XRMD   | Remove the directory (alias de RMD).                                                                                                                   |
| ☐            | XRSQ   |                                                                                                                                                        |
